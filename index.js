...
function setup() {
  var movingCircles = createCanvas(windowWidth, windowHeight);
  circles.push(new Circle(width / 4,height / 2,width / 8));
  circles.push(new Circle(width - width / 4,height / 2,width / 8));
  movingCircles.parent("bg-container");
}
